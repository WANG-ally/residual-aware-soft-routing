#!/usr/bin/env python3
"""Base-only rolling tuning for M4 Hourly LightGBM."""
...
RIDGE_FOLD_PATH = PROJECT_ROOT / "results/m4_hourly_ridge_fold_manifest.csv"
RIDGE_FOLD_SCALER_PATH = PROJECT_ROOT / "results/m4_hourly_ridge_fold_scalers.csv"
RIDGE_CHECKS_PATH = PROJECT_ROOT / "results/m4_hourly_ridge_tuning_checks.csv"

DETAIL_PATH = OUTPUT_ROOT / "results/m4_hourly_lightgbm_rolling_validation.csv"
SUMMARY_PATH = OUTPUT_ROOT / "results/m4_hourly_lightgbm_tuning_summary.csv"
SELECTED_PATH = OUTPUT_ROOT / "results/m4_hourly_selected_lightgbm_params.yaml"
SAMPLING_MANIFEST_PATH = OUTPUT_ROOT / "results/m4_hourly_lightgbm_sampling_manifest.csv"
SAMPLING_POSITIONS_PATH = OUTPUT_ROOT / "results/m4_hourly_lightgbm_sample_positions.parquet"
CHECKS_PATH = OUTPUT_ROOT / "results/m4_hourly_lightgbm_tuning_checks.csv"
FIGURE_PATH = OUTPUT_ROOT / "figures/m4_hourly_lightgbm_tuning.png"
REPORT_PATH = OUTPUT_ROOT / "logs/m4_hourly_lightgbm_tuning_report.json"
...
def main() -> None:
    ...
    if not failed.empty:
        ...
        raise AssertionError(f"M4 Hourly LightGBM tuning failed: {message}")
    ...
    selected = {
        ...
        "fold_boundaries": "identical to m4_hourly_ridge_fold_manifest.csv",
        "training_sample": {
    ...
    fig.suptitle("M4 Hourly LightGBM tuning within base_train only", fontsize=15)
    ...
    print()
    print("M4 Hourly LightGBM 滚动调参全部通过")
