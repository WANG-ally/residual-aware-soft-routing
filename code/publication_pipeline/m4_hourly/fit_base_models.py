#!/usr/bin/env python3
"""Fit frozen M4 Hourly base models and predict pre-test splits."""
...
WINDOW_COUNT_PATH = PROJECT_ROOT / "results/m4_hourly_window_candidate_counts.csv"
SPLIT_SUMMARY_PATH = PROJECT_ROOT / "results/m4_hourly_split_summary.yaml"
RIDGE_PARAMS_PATH = PROJECT_ROOT / "results/m4_hourly_selected_ridge_params.yaml"
LGBM_PARAMS_PATH = PROJECT_ROOT / "results/m4_hourly_selected_lightgbm_params.yaml"
RIDGE_CHECKS_PATH = PROJECT_ROOT / "results/m4_hourly_ridge_tuning_checks.csv"
LGBM_CHECKS_PATH = PROJECT_ROOT / "results/m4_hourly_lightgbm_tuning_checks.csv"

RIDGE_MODEL_PATH = OUTPUT_ROOT / "models/m4_hourly_ridge.joblib"
LGBM_MODEL_PATH = OUTPUT_ROOT / "models/m4_hourly_lightgbm.joblib"
PREDICTION_PATH = OUTPUT_ROOT / "results/m4_hourly_pretest_predictions.parquet"
PER_SERIES_PATH = OUTPUT_ROOT / "results/m4_hourly_pretest_per_series_metrics.csv"
AGGREGATE_PATH = OUTPUT_ROOT / "results/m4_hourly_pretest_aggregate_metrics.csv"
METADATA_PATH = OUTPUT_ROOT / "results/m4_hourly_base_model_fit_metadata.yaml"
CHECKS_PATH = OUTPUT_ROOT / "results/m4_hourly_base_model_fit_checks.csv"
FIGURE_PATH = OUTPUT_ROOT / "figures/m4_hourly_pretest_predictions_T1.png"
REPORT_PATH = OUTPUT_ROOT / "logs/m4_hourly_base_model_fit_report.json"
...
def main() -> None:
    ...
    if not failed.empty:
        ...
        raise AssertionError(f"M4 Hourly base-model audit failed: {message}")
    ...
    for ax, split_name in zip(axes, PREDICTION_SPLITS):
        ...
        ax.set_title(f"M4 Hourly T1: {split_name}")
        ax.set_ylabel("Value")
        ax.grid(alpha=0.2)
