#!/usr/bin/env python3
"""Router-train-only rolling tuning for M4 Hourly soft routing."""
...
MANIFEST_PATH = PROJECT_ROOT / "results/m4_hourly_router_feature_manifest.csv"
...
DETAIL_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_rolling_validation.csv"
SUMMARY_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_tuning_summary.csv"
SELECTED_PATH = OUTPUT_ROOT / "results/m4_hourly_selected_soft_router_params.yaml"
FOLD_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_fold_manifest.csv"
SAMPLING_MANIFEST_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_sampling_manifest.csv"
SAMPLING_POSITIONS_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_sample_positions.parquet"
CHECKS_PATH = OUTPUT_ROOT / "results/m4_hourly_soft_router_tuning_checks.csv"
FIGURE_PATH = OUTPUT_ROOT / "figures/m4_hourly_soft_router_tuning.png"
REPORT_PATH = OUTPUT_ROOT / "logs/m4_hourly_soft_router_tuning_report.json"
...
def main() -> None:
    ...
    check_items: list[tuple[str, bool, str]] = [
        ...
        ("all_414_series_are_present", len(series_order) == EXPECTED_SERIES, str(len(series_order))),
    ...
    if not failed.empty:
        ...
        raise AssertionError(f"M4 Hourly soft-router tuning failed: {message}")
    ...
    fig.suptitle("M4 Hourly soft-router tuning within router_train only", fontsize=15)
