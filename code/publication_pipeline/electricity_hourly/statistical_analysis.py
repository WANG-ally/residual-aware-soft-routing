#!/usr/bin/env python3
"""Statistical analysis from saved Electricity Hourly formal metrics only.
...
Electricity Hourly series; all 321 series have equal test length."""
...
EXPECTED_SERIES = 321
EXPECTED_METHODS = 14
EXPECTED_FORMAL_TEST_ROWS = 1_266_666
EXPECTED_TEST_ROWS_PER_SERIES = 3_946
EXPECTED_TEST_RELATIVE_STEPS = 3_946
EXPECTED_EVALUATOR_HASH = (
    "8d9d76e472527cedb690bf1a92ca0297bd9e15f149a212b889820ac152bb4f61"
)
EXPECTED_AUTHORIZATION_ID = (
    "fd492a954151e49bba0a9ff14b574fe9379780bed843364acc7eff2a30f2edc8"
)
EXPECTED_FINAL_FREEZE_ID = (
    "3664f0711faa5625278e05ac2d45a03c4d7561667f4b2579830c624954386f29"
)

RECEIPT_PATH = PROJECT_ROOT / "logs/electricity_hourly_formal_test_access_receipt.json"
AUTHORIZATION_PATH = PROJECT_ROOT / "logs/electricity_hourly_evaluator_authorization.json"
EVALUATOR_PATH = PROJECT_ROOT / "code/publication_pipeline/electricity_hourly/formal_test.py"
PER_SERIES_PATH = (
    PROJECT_ROOT / "results/electricity_hourly_test_per_series_metrics.csv"
)
...
CI_PATH = OUTPUT_ROOT / "results/electricity_hourly_method_bootstrap_ci.csv"
PAIRWISE_PATH = OUTPUT_ROOT / "results/electricity_hourly_primary_pairwise_tests.csv"
NONINFERIORITY_PATH = (
    OUTPUT_ROOT / "results/electricity_hourly_noninferiority_tests.csv"
)
SUMMARY_PATH = OUTPUT_ROOT / "results/electricity_hourly_statistical_summary.yaml"
CHECKS_PATH = OUTPUT_ROOT / "results/electricity_hourly_statistical_analysis_checks.csv"
FIGURE_PATH = OUTPUT_ROOT / "figures/electricity_hourly_statistical_comparison.png"
REPORT_PATH = OUTPUT_ROOT / "logs/electricity_hourly_statistical_analysis_report.json"
...
def main() -> None:
    ...
    formal_identity_valid = bool(
        ...
        and int(receipt.get("formal_test_rows", -1))
        == EXPECTED_FORMAL_TEST_ROWS
    ...
    per_series_identity_valid = bool(
        ...
        .eq(1)
        .all()
        and int(per_series["test_rows"].min())
        == EXPECTED_TEST_ROWS_PER_SERIES
        and int(per_series["test_rows"].max())
        == EXPECTED_TEST_ROWS_PER_SERIES
    )
    record_check(
    ...
    statistical_summary = {
        ...
        "series_count": series_count,
        "series_length_structure": "equal test length for all series",
    ...
    if not failed_checks.empty:
        raise AssertionError(
            f"Electricity Hourly statistical checks failed: {failed_checks.to_dict('records')}"
        )
    ...
    print()
    print("Electricity Hourly 正式测试统计分析全部通过")
